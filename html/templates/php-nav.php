    ...
    <nav class="navbar">
        <div class="container-fluid">
            <ul class="nav nav-pills ml-auto">
                <li><a class="nav-link mx-2 border-white border <?php echo ($_SERVER['REQUEST_URI'] != '/') ? "text-white" : "active bg-white text-black"; ?>" href="./">Přehled kvízů</a></li>
                <li><a class="nav-link mx-2 border-white border <?php echo ($_SERVER['REQUEST_URI'] != '/about') ? "text-white" : "active bg-white text-black"; ?>" href="./about">Informace o stránce</a></li>
            </ul>
